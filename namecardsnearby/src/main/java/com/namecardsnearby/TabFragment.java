...
//                    ImageView im = (ImageView) getView().findViewById(R.id.my_detail_photo);
...
//                    }
//
//                    im = (ImageView) getView().findViewById(R.id.my_detail_gender);
...
//                    }
//
//                    TextView tv = (TextView) getView().findViewById(R.id.my_detail_name);
//                    tv.setText(myCard.getmName());
//
//                    if (!myCard.getmPhone().equals("")) {
//                        tv = (TextView) getView().findViewById(R.id.my_detail_phone);
//                        tv.setText(myCard.getmPhone());
//                    }
//
//                    if (!myCard.getmEmail().equals("")) {
//                        tv = (TextView) getView().findViewById(R.id.my_detail_email);
//                        tv.setText(myCard.getmEmail());
//                    }
//
//                    if (!myCard.getmWebsite().equals("")) {
//                        tv = (TextView) getView().findViewById(R.id.my_detail_website);
//                        tv.setText(myCard.getmWebsite());
//                    }
//
//                    if (!myCard.getmOther().equals("")) {
//                        tv = (TextView) getView().findViewById(R.id.my_detail_aboutme_full);
//                        tv.setText(myCard.getmOther());
//                    }
//
//                    ImageButton ib = (ImageButton) getView().findViewById(R.id.my_detail_facebook);
...
//                        ib = (ImageButton) getView().findViewById(R.id.my_detail_instagram);
//                        ib.setVisibility(View.VISIBLE);
//                        ib.setOnClickListener(new View.OnClickListener() {
//                            @Override
//                            public void onClick(View v) {
...
//                    }
                ...
                /*case IGNORED_TAB_INT:
                    ...
                    ignoredCardAdapter = new CardAdapter( getView(), IGNORED_TAB_INT );
                    // The fragment is the object which implement the ClickListener
                    ...
                    ignoredRecyclerView.setLayoutManager( new LinearLayoutManager( getView() ) );
                    break;*/
                /*default:
